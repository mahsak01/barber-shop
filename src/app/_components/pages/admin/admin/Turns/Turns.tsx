...
import { DashbordListResult } from "@/app/(pages)/admin/_api/admin.types";
...
const Turns = () => {
  ...
  function DashbordListOnSuccess(res: DashbordListResult) {
    console.log(res);
  }
  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 flex flex-col">
      <div className="flex justify-between">
        <h2 className="font-semibold mb-2">نوبت‌های آینده</h2>
        <Dropdown
        ...
        {!dashbordList ? (
          <>
            ...
            <p className="font-semibold">
              نوبتی برای هفت روز آینده وجود ندارد.
            </p>
          </>
        ) : (
